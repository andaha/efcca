...
//Side Navigation
  ...
  <div class="col-sm-6">
    <div class="row">
      <div class="col-xs-12">
      <?php
			      if(isset($_GET['page'])) {	//Gets content from tbl_pg_intros table
		...
		/**************												*****************/
					...
					//Fetch and Display Events	
					} else if(isset($_GET['page']) && $_GET['page'] == "certificate") {
						include("pages/certificate.php");

					//Fetch and Display Collaboration	
					} else if(isset($_GET['page']) && $_GET['page'] == "networking") {
						include("pages/collaboration.php");			
