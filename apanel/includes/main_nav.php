...
<!--						<img src="assets/img/brand/logo1.png" class="header-brand-img" alt="EFCC Academy Logo">-->
        EFCC Academy
    </a>
    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg beep"><i class="ion-ios-email-outline"></i></a>
            <?php include("includes/messages.phtml"); ?>
        </li>
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link  nav-link-lg beep"><i class="ion-ios-bell-outline"></i></a>
            <?php include("includes/notifications.phtml"); ?>
        </li>
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg">
            <img src="<?php echo $_SESSION['picture']; ?>" alt="Staff Picture" class="rounded-circle w-32">
            <div class="d-sm-none d-lg-inline-block"><?php echo $_SESSION['fullname']; ?></div></a>
            <div class="dropdown-menu dropdown-menu-right">
                <a href="profile.html" class="dropdown-item has-icon">
                    <i class="ion ion-android-person"></i> Profile
                </a>
                <a href="?action=logout&logout=true" class="dropdown-item has-icon">
