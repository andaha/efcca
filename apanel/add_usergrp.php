                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control" name="group_name" id="txtGroupName" placeholder="Group Name">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="txtDescription" class="col-md-3 col-form-label">Description</label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="group_desc" id="txtDescription" placeholder="Description">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row overflow-hidden">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="can_add" value="1" class="custom-switch-input">
                                                        <span class="custom-switch-indicator"></span>
													</label>
                                                </div>
                                            </div>
                                            <div class="form-group row overflow-hidden">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="can_del" value="1" class="custom-switch-input">
                                                        <span class="custom-switch-indicator"></span>
													</label>
                                                </div>
                                            </div>
                                            <div class="form-group row overflow-hidden">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="can_upd" value="1" class="custom-switch-input">
                                                        <span class="custom-switch-indicator"></span>
													</label>
                                                </div>
                                            </div>
                                            <div class="form-group row overflow-hidden">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="can_adm" value="1" class="custom-switch-input">
                                                        <span class="custom-switch-indicator"></span>
													</label>
                                                </div>
                                            </div>
                                            <div class="form-group row overflow-hidden">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="custom-switch">
                                                        <input type="checkbox" name="can_apprv" value="1" class="custom-switch-input">
                                                        <span class="custom-switch-indicator"></span>
													</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-0 mt-2 row justify-content-end">
                                                <div class="col-md-9">
                                                    <button type="submit" class="btn btn-info" name="addUserGrpBtn">Add</button>
