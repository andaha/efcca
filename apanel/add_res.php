                ...
                <div class="app-content">
                    <section class="section">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-" aria-current="page">Add A Research</li>
                        </ol>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="res_title" id="txtres_title" placeholder="Research Title" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="txtres_abstract" class="col-md-2 col-form-label">Research Abstract</label>
                                                <div class="col-md-10">
                                                    <textarea rows="30" rows="30" class="form-control" name="res_abstract" id="txtres_abstract" placeholder="Research Abstract"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="txtres_keywords" class="col-md-2 col-form-label">Keyword(s)</label>
                                                <div class="col-md-10">
                                                    <textarea rows="30" rows="30" class="form-control" name="res_keywords" id="txtres_keywords" placeholder="Keywords"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="txtres_date" class="col-md-2 col-form-label">Date Entered</label>
                                                <div class="col-md-2">
                                                    <input type="Date" class="form-control" name="res_date" id="txtres_date" placeholder="Research date">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea rows="60" rows="60" class="form-control" name="res_detail" id="txtres_detail" placeholder="Research Details"></textarea>
                                                </div>
                                            </div>   
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="res_category" id="txtres_category" placeholder="category">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="res_sponsor" id="txtres_sponsor" placeholder="Sponsor">
                                                </div>
                                            </div>
<!--
                                            <div class="form-group row">
                                            ...
                                            <br /><legend class="small-head" style=" font-size: small; font-weight: bolder; font-style: italic; ">Contact Person</legend>
...
-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control" name="res_officer" id="txtres_officer" placeholder="Research Officer">
                                                </div>

                                                <label for="txtres_file" class="col-md-1 col-form-label">File No</label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="fileno" id="txtres_file" placeholder="File No">
                                                </div>
                                            </div>                                            
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="res_offr_gsm" id="txtres_offr_gsm" placeholder="Phone No">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="txtres_offr_addr" class="col-md-2 col-form-label">Contact Address</label>
                                                <div class="col-md-10">
                                                    <textarea rows="30" rows="30" class="form-control" name="res_offr_addr" id="txtres_offr_addr" placeholder="Contact Address"></textarea>
                                                </div>
                                            </div>                                            
                                            ...
                                            <div class="form-group mb-0 mt-2 row justify-content-end">
                                                <div class="col-md-10">
                                                    <button type="submit" class="btn btn-info" name="addResBtn">Save</button>
