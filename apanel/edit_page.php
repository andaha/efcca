			...
			<div class="main-wrapper" >
                ...
                <div class="app-content">
                    <section class="section">
                        ...
                        <?php
                            $get_page = $apanel->get_rec("SELECT * FROM tbl_pg_intros WHERE pagename='{$_GET['pagename']}'");
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" name="intro_title" id="pagetitle" placeholder="Page Title" value="<?php echo $page['intro_title']; ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="pagename" class="col-md-3 col-form-label">Page Name</label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="pagename" id="pagename" placeholder="Page Name" value="<?php echo $page['pagename']; ?>" readonly>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="intro_text" id="intro_text" placeholder="Page Content" rows="35"><?php echo $page['intro_text']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group mb-0 mt-2 row justify-content-end">
                                                <div class="col-md-9">
                                                    <button type="submit" class="btn btn-info" name="updPageBtn">Save</button>
