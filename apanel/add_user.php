                ...
                <div class="app-content">
                    <section class="section">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-" aria-current="page">New User</li>
                        </ol>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="confirmpassword" class="form-control" placeholder="Confirm Password" id="txtConfirmPassword">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <select name="group_id" class="form-control select2" id="selUserGroup">
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $usergroup['group_id']; ?>">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <select name="secret_quest" class="form-control select2" id="selSecretQuestion">
                                                        ...
                                                        <option value="3">Where did your first meet your spouse?</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" name="secret_answer" class="form-control" placeholder="Answer to Secret Question" id="txtAnswer">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" name="surname" class="form-control" placeholder="Surname" id="txtSurname">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="txtOthernames" class="col-md-3 control-label">Othernames</label>
                                                <div class="col-md-6">
                                                    <input type="text" name="othernames" class="form-control" placeholder="Firstname Othername" id="txtOthernames">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="txtDesignation" class="col-md-3 control-label">Designation</label>
                                                <div class="col-md-4">
                                                    <input type="text" name="designation" class="form-control" placeholder="Designation" id="txtDesignation">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="txtPhone" class="col-md-3 control-label">Phone</label>
                                                <div class="col-md-3">
                                                    <input type="text" name="gsm" class="form-control" placeholder="Phone Number" id="txtPhone">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="txtEmail" class="col-md-3 control-label">Email Address</label>
                                                <div class="col-md-4">
                                                    <input type="email" name="email" class="form-control" placeholder="Email Address" id="txtEmail">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group mb-0 mt-2 row justify-content-end">
                                                <div class="col-md-9">
                                                    <button type="submit" class="btn btn-info" name="addUserBtn">Add</button>
