                ...
                <div class="app-content">
                    <section class="section">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-" aria-current="page">New Lecture</li>
                        </ol>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="lect_title" id="lectTitle" placeholder="Lecture Title">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="txtLectKeyword" class="col-md-2 col-form-label">Keyword</label>
                                                <div class="col-md-3">
                                                    <input type="text" name="lect_keyw" class="form-control" id="txtLectKeyword" placeholder="dd/mm/yyyy">
                                                </div>
                                                <label for="txtLectDate" class="col-md-2 col-form-label">Lecture Date</label>
                                                <div class="col-md-2">
                                                    <input type="date" name="lect_date" class="form-control" id="txtLectDate" placeholder="mm/dd/yyyy">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control" name="lect_abstract" id="lectAbstract" placeholder="Content" rows="35"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="lecturer" id="txtLecturer" class="form-control" placeholder="Lecturer Name">
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="email" name="lect_email" class="form-control" id="txtEmail" placeholder="Lecturer Email">
                                                </div>
                                                <div class="col-md-2">
                                                    <input type="text" name="lect_gsm" class="form-control" placeholder="Lecturer Phone" id="txtPhone">
                                                </div>
                                            </div>
                                            <div class="form-group mb-0 mt-2 row justify-content-end">
                                                <div class="col-md-9">
                                                    <input type="hidden" value="<?php echo $_SESSION['username']; ?>" name="addedby">
                                                    <button type="submit" class="btn btn-info" name="addLectureBtn">Save</button>
